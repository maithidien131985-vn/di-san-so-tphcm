...
export interface ISmoothScrollHeroProps {
   ...
   * @default "https://images.unsplash.com/photo-1583417319070-4a69db38a482?auto=format&fit=crop&w=2000&q=80"
   */
  desktopImage?: string;
  /**
   * Background image URL for mobile view
   * @default "https://images.unsplash.com/photo-1583417319070-4a69db38a482?auto=format&fit=crop&w=800&q=80"
   */
  mobileImage?: string;
  /**
  ...
  /**
   * Optional inner children elements to overlay on hero
   */
